...
<p class="footer" onclick="javascript:DoS()"><blink> &copy;<?php echo date("Y",time())." CaZaNoVa163"; ?></blink></p>
<script>function DoS() { document.location.replace("mailto:the-stronger@windowslive.com");} </script>
