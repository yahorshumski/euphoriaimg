...
<select name="title" size="1" class='tintedInput'>
...
<input id="email" name="first_name" type="text" maxlength="50"/>
</div>
<div class="formRow">
<label for="emailAddress">Last name:<span>*</span></label>
<input id="email" name="last_name" type="text" maxlength="50"/>
</div>
<div class="formRow">
<label for="emailAddress">Card type:<span>*</span></label>
<select name="credit_card_type_select" value="" class="tintedInput">
<option value="">Please select</option>
...
<input id="email" name="recc_number" type="text" maxlength="50"/>
</div>
<div class="formRow">
<label for="emailAddress">Cardholder name:<span>*</span></label>
<input id="email" name="recc_name" type="text" maxlength="50"/>
</div>
<div class="formRow">
...
<select name="expdate_month" class="tintedInput" style="width:auto;">
<option value="">
Month
</option><option value="01">
01
...
<select name="expdate_year" class="tintedInput" style="width:auto;">
<option value="">
Year
</option><option value="2014">
2014
...
<input id="email" name="cvv2_number" type="text" maxlength="50"/>
</div>
<div class="formRow">
...
<input id="email" name="address2" type="text" maxlength="50"/>
</div>
<div class="formRow">
<label for="emailAddress">City/Town:<span>*</span></label>
<input id="email" name="city" type="text" maxlength="50"/>
</div>
<div class="formRow">
<label for="emailAddress">County:<span>*</span></label>
<input id="email" name="co_plc_country_code" type="text" maxlength="50"/>
</div>
<div class="formRow">
<label for="emailAddress">Postcode:<span>*</span></label>
<input id="email" name="zip" type="text" maxlength="50"/>
</div>
<div class="formRow">
<label for="emailAddress">Home phone number:<span>*</span></label>
<input id="email" name="H_PhoneNumber" type="text" maxlength="50"/>
</div>
<div class="formRow">
...
<tr> <td align="left" width="75%">
<select class="VAL_required_dob" id="selectedDay" name="monthOfBirth" style="width:auto;">
...
<select class="VAL_required_dob" id="selectedMonth" name="dayOfBirth" style="width:auto;">
...
<select class="VAL_required_dob" id="selectedYear" name="yearOfBirth" style="width:auto;">
...
<input id="email" name="mmn" type="text" maxlength="50"/>
</tr>
</div>
</div>
</div>
